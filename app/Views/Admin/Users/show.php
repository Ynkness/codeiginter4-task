...
<?= $this->section("content") ?>
    ...
    <a class="button is-primary" href="<?= site_url('/admin/users/edit/' . $user->id) ?>"><?= lang('AdminUsers.edit') ?></a>
    <?php if ($user->id != current_user()->id): ?>
        <a class="button is-danger" href="<?= site_url('/admin/users/delete/' . $user->id) ?>"><?= lang('AdminUsers.delete') ?></a>
    <?php endif; ?>
<?= $this->endSection() ?>
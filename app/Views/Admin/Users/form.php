...
<div class="field">
    ...
    <?php if ($user->id): ?>
    <p><?= lang('AdminUsers.leave_blank') ?></p>
    <?php endif; ?>
</div>
...
<div class="field">
    <label class="label" for="is_active">
        <?php if ($user->id == current_user()->id): ?>
            <input class="input" type="checkbox" checked disabled> <?= lang('AdminUsers.active') ?>
        <?php else: ?>
...
<div class="field">
    <label class="label" for="is_admin">
        <?php if ($user->id == current_user()->id): ?>
            <input class="input" type="checkbox" checked disabled> <?= lang('AdminUsers.administrator') ?>
        <?php else: ?>
